...
// НОВАЯ СТРУКТУРА: L - Min, M - Max, N - Investment Score, O - Рекомендация, P - Фаза, Q - Потенциал, R - Тренд (объединенный), S - Hero Trend, T - Risk Level, U - Продать (убрали Купить?, метрики и Дней смены из отображения)
...
// НОВАЯ СТРУКТУРА: G - Min, H - Max, I - Investment Score, J - Рекомендация, K - Фаза, L - Потенциал, M - Тренд (объединенный), N-S - Hero Stats, T+ - Даты
